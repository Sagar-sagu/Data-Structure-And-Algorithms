    ...
    while (true) {
      ...
      switch (Option)
      {
       ...
       case "6":LinearQueue.ViewElements();
           break;
       case "7":System.out.println("not yet Implement");
                //LinearQueue.Search();
           break;
       case "8":System.out.println("not yet Implement");
                //LinearQueue.Size();
           break;
       case "9":LinearQueue.Capacity();
           break;
       case "10":System.out.println("not yet Implement");
                  //LinearQueue.RemainSlots();
           break;
